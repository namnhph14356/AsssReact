...
import { Breadcrumb, Col, Layout, Menu, message, Modal, Row } from 'antd';
      ...
      <Row gutter={[8, 16]}>
        ...
        <Col span={5}>
          <Row style={{ lineHeight: "1.5" }}>
            <Col span={5} style={{ margin: "auto 0", fontSize: "30px" }}><svg width="21" height="25" viewBox="0 0 21 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Col span={3}>
          <Row style={{ lineHeight: "1.5", }}>
            <Col span={9} style={{ margin: "auto 0", fontSize: "30px" }}><Link to='cart'><svg width="21" height="25" viewBox="0 0 21 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Col span={6}>
          <Row style={{ lineHeight: "1.5" }}>
            <Link to={'/login'} style={{ color: "#fff" }}> <Col span={8} style={{ margin: "auto 0", fontSize: "30px" }}> </Col></Link>
